...
- result(result_id, content, filepath, content_sha256)
...
def insert_to_database(db_path: Path, parsed_results: List[Dict]):
    ...
    Note:
        - result table is already populated by generate_batch.py
...
def main():
    ...
    if not db_path.exists():
        ...
        print("Please run generate_batch.py first to create database")
        sys.exit(1)
